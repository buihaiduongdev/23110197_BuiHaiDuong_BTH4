...
<div class="container mt-5">
    ...
    <c:choose>
        ...
        <c:when test="${sessionScope.user.roleid == 3}">
            <h3 class="mb-4 text-danger">Admin Home - Quản lý tất cả Category</h3>
        </c:when>
    </c:choose>
            ...
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${sessionScope.user.roleid == 3}">
                        <a href="${pageContext.request.contextPath}/category/edit?id=${cate.cateid}" 
                           class="btn btn-warning btn-sm">Sửa</a>
                        <a href="${pageContext.request.contextPath}/category/delete?id=${cate.cateid}" 
                           class="btn btn-danger btn-sm">Xóa</a>
                    </c:if>

                    <!-- User/Manager: chỉ sửa/xóa category của chính mình -->
                    <c:if test="${sessionScope.user.roleid != 3 && sessionScope.user.userid == cate.user.userid}">
                        <a href="${pageContext.request.contextPath}/category/edit?id=${cate.cateid}" 
                           class="btn btn-warning btn-sm">Sửa</a>
                        <a href="${pageContext.request.contextPath}/category/delete?id=${cate.cateid}" 
                           class="btn btn-danger btn-sm">Xóa</a>
